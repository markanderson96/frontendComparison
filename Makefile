.PHONY: clean lint requirements train evaluate all test_environment create_environment
...
debug:
	$(PYTHON_INTERPRETER) src/main.py set.train=true set.debug=true
